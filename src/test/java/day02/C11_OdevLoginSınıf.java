...
public class C11_OdevLoginSınıf {//HOCANIN SINIF COZUMU
    public static void main(String[] args)throws InterruptedException {
        ...
        linklerListesi.forEach(t-> System.out.println(t.getText()));   // linklerListesi ndeki her (stream de yazabilirim)
                                                                //her webelemet i al yaziya evir getText ile ve sonra yazdir
        //6. Sayfayı kapatınız
        driver.close();
